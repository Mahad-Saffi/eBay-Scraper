...
from scraper_module1 import Scraper
...
class ScraperUI(QMainWindow):
    ...
    def __init__(self):
        ...
        self.sort_algo_dropdown.addItems(["Merge Sort", "Quick Sort", "Bubble Sort", "Heap Sort"])
        ...
        self.search_algo_dropdown.addItems(["Linear Search", "Binary Search"])
    ...
    def sort_data(self):
        ...
        sorted_data = self.scraper.sort_data(selected_algo, selected_column)
